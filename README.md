...
End-to-end pipeline for Alzheimer’s detection from brain MRI, combining a CNN classifier with Bayesian models to quantify uncertainty and disease severity.  
